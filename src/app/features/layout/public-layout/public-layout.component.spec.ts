...
describe('PublicLayoutComponent', () => {
  ...
  it('should render header with logo.svg image', async () => {
    const fixture = TestBed.createComponent(PublicLayoutComponent);
  ...
  describe('switchLanguage', () => {
    ...
    let fixture: ReturnType<typeof TestBed.createComponent<PublicLayoutComponent>>;
    ...
    it('should swap /post/my-post to /pt/post/my-post', async () => {
      ...
      component['switchLanguage']('PORTUGUESE');
      await fixture.whenStable();
      expect(router.url).toBe('/pt/post/my-post');
      expect(component.languageService.setLanguage).not.toHaveBeenCalled();
    });
    ...
    it('should swap /pt/post/my-post to /post/my-post', async () => {
      ...
      component['switchLanguage']('ENGLISH');
      await fixture.whenStable();
    ...
    it('should fall back to setLanguage on non-public routes', async () => {
      ...
      component['switchLanguage']('PORTUGUESE');
      await fixture.whenStable();
      expect(component.languageService.setLanguage).toHaveBeenCalledWith('PORTUGUESE');
